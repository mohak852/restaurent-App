...
class FirstOn extends StatefulWidget {
  @override
  _FirstOnState createState() => _FirstOnState();
}

class _FirstOnState extends State<FirstOn> {
  @override
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              InkWell(
                  onTap: ()=>Navigator.of(context).pushReplacementNamed('/SecondOn'),
                  child: Container(
                      height: 40.0,
                      width: 70.0,
                      decoration: BoxDecoration(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(image: AssetImage('assets/WhatsApp Image 2020-06-24 at 3.00.53 AM.jpeg'))
                          ),
                        )
                      ],
                    ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.contain,
                                image: AssetImage('assets/delivery-boy-delivering-pizza-home_183044-57.jpg'),
                              )
                          ),
                        ),
                      ],
